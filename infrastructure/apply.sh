...
kubectl create secret generic social-service-secret --from-env-file=k8s/secrets/.env.social-service -n reveria-dev --dry-run=client -o yaml | kubectl apply -f -
...
#SOCIAL-SERVICE
kubectl apply -f k8s/services/social-service/deployment.yml
